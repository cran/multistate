...
m4 <-function(t1, t2, sequence, weights=NULL, dist, cuts.12=NULL,cuts.13=NULL,cuts.14=NULL,cuts.23=NULL,cuts.24=NULL,ini.base.12=NULL, ini.base.13=NULL, ini.base.14=NULL, ini.base.23=NULL, ini.base.24=NULL, cov.12=NULL, init.cov.12=NULL, names.12=NULL, cov.13=NULL, init.cov.13=NULL, names.13=NULL, cov.14=NULL, init.cov.14=NULL, names.14=NULL, cov.23=NULL, init.cov.23=NULL, names.23=NULL, cov.24=NULL, init.cov.24=NULL, names.24=NULL, conf.int=TRUE, silent=TRUE, precision=10^(-6))
{
...
if (is.na(min(t1)))
		cat("Warning: individuals with missing values for 't1' will be removed from the analysis \n")
...
if (!all(is.na(t2[which(sequence==1 | sequence==13 | sequence==14)])))		
		stop("Arguments 't2' should be NA for right-censored individuals in X=1 or individuals who directly transited from X=1 to X=3 or to X=1 to X=4")
...
c12<-function(t1, t2, z12, z13, z14, z23, z24, cut12, cut13, cut14, cut23, cut24)
 {return(log.h12(t1, z12, cut12) - H12(t1, z12, cut12) - H13(t1, z13, cut13) - H14(t1, z14, cut14) - H23(t1, t2, z23, cut23) - H24(t1, t2, z24, cut24))}
...
c123<-function(t1, t2, z12, z13, z14, z23, z24, cut12, cut13, cut14, cut23, cut24)
 {return(log.h12(t1, z12, cut12) - H12(t1, z12, cut12) - H13(t1, z13, cut13) - H14(t1, z14, cut14) + log.h23(t2, z23, cut23) - H23(t1, t2, z23, cut23) - H24(t1, t2, z24, cut24))}

c124<-function(t1, t2, z12, z13, z14, z23, z24, cut12, cut13, cut14, cut23, cut24)
 {return(log.h12(t1, z12, cut12) - H12(t1, z12, cut12) - H13(t1, z13, cut13) - H14(t1, z14, cut14) + log.h24(t2, z24, cut24) - H23(t1, t2, z23, cut23) - H24(t1, t2, z24, cut24))}
...
return(list(
object="m4 (4-state time-inhomogeneous markov model)",
dist=dist,
cuts.12=cuts.12,
cuts.13=cuts.13,
cuts.14=cuts.14,
